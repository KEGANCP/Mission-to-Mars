 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[WDM] - Driver has been saved in cache [/Users/kegancp/.wdm/drivers/chromedriver/mac64/95.0.4638.54]\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    results_dict = {'image_url': image_url, 'title': hemisphere_img_title}\n",
    "    \n",
